...
# Cycle Time Response Models
class CycleTimeMachineCount(BaseModel):
    OK: int
    WARNING: int
    CRITICAL: int


class CycleTimeMachine(BaseModel):
    machine_name: str
...
class CycleTimeLine(BaseModel):
    line_name: str
    line_state: str
    count: CycleTimeLineCount
    machines: List[CycleTimeMachine]


class CycleTimeFactoryLayout(BaseModel):
    parameter_name: str
    from_time: str
    to_time: str
    lines: List[CycleTimeLine]
...
class CycleTimeMachineDetails(BaseModel):
    machine_name: str
    machine_id: Optional[int]
    parameter_name: str
    cycle_time_value: float
    machine_state: str
    ...
    warning_limit: float
    critical_limit: float
    cycle_time_data: List[CycleTimeDataPoint]
    message: Optional[str] = None


class CycleTimeMachineList(BaseModel):
    machines: List[str]
