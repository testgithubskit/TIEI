...
class EmailUserRequest(BaseModel):
    """
    PYDANTIC MODEL FOR EMAIL USER REQUEST
    =====================================

    This is a class (pydantic class) to represent an email user for validation.
    """
...
class EmailUserUpdate(BaseModel):
    """
    PYDANTIC MODEL FOR EMAIL USER UPDATE
    ====================================

    This is a class (pydantic class) to represent an email user update.
    """
